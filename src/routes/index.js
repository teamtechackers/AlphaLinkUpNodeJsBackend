...
router.get('/check-duplicate-country', AdminController.checkDuplicateCountry);
router.post('/check-duplicate-country', uploadFormData.none(), AdminController.checkDuplicateCountry);
router.get('/list-state', AdminController.viewState);
router.post('/list-state', uploadFormData.none(), AdminController.viewState);
router.get('/submit_state', AdminController.submitState);
router.post('/submit_state', uploadFormData.none(), AdminController.submitState);
router.get('/list_state_ajax', AdminController.listStateAjax);
router.post('/list_state_ajax', uploadFormData.none(), AdminController.listStateAjax);
router.get('/check_duplicate_state', AdminController.checkDuplicateState);
router.post('/check_duplicate_state', uploadFormData.none(), AdminController.checkDuplicateState);
router.get('/delete_state', AdminController.deleteState);
router.post('/delete_state', uploadFormData.none(), AdminController.deleteState);
...
router.get('/get_state_list', AdminController.getStateList);
router.post('/get_state_list', uploadFormData.none(), AdminController.getStateList);
