...
class AdminController {
  ...
  // View event mode - PHP compatible version
  static async viewEventMode(req, res) {
    try {
      // Support both query parameters and form data
      const { user_id, token } = {
        ...req.query,
      ...
      console.log('viewEventMode - Parameters:', { user_id, token });
      ...
      console.error('viewEventMode error:', error);
      return res.json({
        status: false,
        rcode: 500,
  ...
  // Submit event mode - PHP compatible version
  static async submitEventMode(req, res) {
    try {
      // Support both query parameters and form data
      const { user_id, token, row_id, name, status } = {
        ...req.query,
      ...
      console.log('submitEventMode - Parameters:', { user_id, token, row_id, name, status });
      ...
      console.error('submitEventMode error:', error);
      return res.json({
        status: 'Error',
  ...
  // List event mode ajax - PHP compatible version
  static async listEventModeAjax(req, res) {
    try {
      // Support both query parameters and form data
      const { user_id, token } = {
        ...req.query,
      ...
      console.log('listEventModeAjax - Parameters:', { user_id, token });
      ...
      console.error('listEventModeAjax error:', error);
      return res.json({
        status: false,
        rcode: 500,
  ...
  // Check duplicate event mode - PHP compatible version
  static async checkDuplicateEventMode(req, res) {
    try {
      // Support both query parameters and form data
      const { user_id, token, name, id } = {
        ...req.query,
      ...
      console.log('checkDuplicateEventMode - Parameters:', { user_id, token, name, id });
      ...
      console.error('checkDuplicateEventMode error:', error);
      return res.json({
        status: false,
        rcode: 500,
  ...
  // Delete event mode - PHP compatible version
  static async deleteEventMode(req, res) {
    try {
      // Support both query parameters and form data
      const { user_id, token, keys } = {
        ...req.query,
      ...
      console.log('deleteEventMode - Parameters:', { user_id, token, keys });
      ...
      console.error('deleteEventMode error:', error);
      return res.json({
        status: 'Error',
  ...
  // View event type - PHP compatible version
  static async viewEventType(req, res) {
    try {
      // Support both query parameters and form data
      const { user_id, token } = {
        ...req.query,
      ...
      console.log('viewEventType - Parameters:', { user_id, token });
      ...
      console.error('viewEventType error:', error);
      return res.json({
        status: false,
        rcode: 500,
  ...
  // Submit event type - PHP compatible version
  static async submitEventType(req, res) {
    try {
      // Support both query parameters and form data
      const { user_id, token, row_id, name, status } = {
        ...req.query,
      ...
      console.log('submitEventType - Parameters:', { user_id, token, row_id, name, status });
      ...
      console.error('submitEventType error:', error);
      return res.json({
        status: 'Error',
  ...
  // List event type ajax - PHP compatible version
  static async listEventTypeAjax(req, res) {
    try {
      // Support both query parameters and form data
      const { user_id, token } = {
        ...req.query,
      ...
      console.log('listEventTypeAjax - Parameters:', { user_id, token });
      ...
      console.error('listEventTypeAjax error:', error);
      return res.json({
        status: false,
        rcode: 500,
  ...
  // Check duplicate event type - PHP compatible version
  static async checkDuplicateEventType(req, res) {
    try {
      // Support both query parameters and form data
      const { user_id, token, name, id } = {
        ...req.query,
      ...
      console.log('checkDuplicateEventType - Parameters:', { user_id, token, name, id });
      ...
      console.error('checkDuplicateEventType error:', error);
      return res.json({
        status: false,
        rcode: 500,
  ...
  // Delete event type - PHP compatible version
  static async deleteEventType(req, res) {
    try {
      ...
      console.log('deleteEventType - Parameters:', { user_id, token, keys });
  ...
  // Submit folders - PHP compatible version
  ...
  // List folders ajax - PHP compatible version
  ...
  static async checkDuplicateFolders(req, res) {
    try {
      ...
      if (parseInt(id) > 0) {
        // Editing existing folder - exclude current record
        condition = 'id != ? AND deleted = 0 AND name = ?';
        params = [id, name];
      } else {
        // Adding new folder
      ...
      const duplicateCheck = await query(
        `SELECT COUNT(*) as count FROM folders WHERE ${condition}`,
        params
      );
  ...
  // Delete folders - PHP compatible version
  ...
  // Get state list - PHP compatible version
  static async getStateList(req, res) {
    try {
      // Support both query parameters and form data
      const { user_id, token, keys } = {
        ...req.query,
      ...
      console.log('getStateList - Parameters:', { user_id, token, keys });
      ...
      // Get states for the country (matching PHP exactly)
      const states = await query('SELECT * FROM states WHERE country_id = ? AND status = 1 ORDER BY name ASC', [keys]);
      ...
      if (states.length > 0) {
        ...
        option = "<option value=''>State List Empty</option>";
      }

      // Return HTML options (matching PHP exactly)
  ...
  // Get city list - PHP compatible version
  static async getCityList(req, res) {
    try {
      ...
      console.log('getCityList - Parameters:', { user_id, token, keys });
      ...
      // Get cities for the state (matching PHP exactly)
      const cities = await query('SELECT * FROM cities WHERE state_id = ? AND status = 1 ORDER BY name ASC', [keys]);
